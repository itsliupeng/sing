...
(function() {
  $(document).on('focus', '.markdown-area textarea', function() {
    return $(this).closest('.markdown-area').addClass('focus');
  });

  $(document).on('blur', '.markdown-area textarea', function() {
    return $(this).closest('.markdown-area').removeClass('focus');
  });

  $(document).on('click', '.markdown-area a[data-behaviors~="preview"]', function(e) {
    var area, preview, textarea;
...
(function() {
  $(document).on('page:update', function() {
    ...
    return $("time[data-behaviors~=timeago]").timeago();
  });
